...
import { HelloworldBsv } from '../src/contracts/helloworldBsv'
...
async function main() {
    await HelloworldBsv.loadArtifact()
    ...
    const instance = new HelloworldBsv(
    ...
    console.log('HelloworldBsv contract was successfully deployed!')
